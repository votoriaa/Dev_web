...
<body>
    ...
    <nav class="menu-bar" role="navigation" aria-label="Menu principal lanchonete">
        ...
        <!-- <a href="${pageContext.request.contextPath}${URL_BASE}/VendaControlador?opcao=cancelar" data-icon="🛒">Venda</a>comment -->
        <a href="${pageContext.request.contextPath}${URL_BASE}/FuncionarioControlador?opcao=cancelar" data-icon="🍳">Funcionário</a>
        <!-- <a href="${pageContext.request.contextPath}${URL_BASE}/ItensVendaControlador?opcao=cancelar" data-icon="📦">Itens Vendidos</a>comment -->
