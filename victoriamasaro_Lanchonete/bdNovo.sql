...
CREATE TABLE IF NOT EXISTS `produto` (
  ...
  KEY `fornecedor_codFornecedor` (`fornecedor_codFornecedor`),
  ...
  CONSTRAINT `fornecedor` FOREIGN KEY (`fornecedor_codFornecedor`) REFERENCES `fornecedor` (`codFornecedor`)
...
CREATE TABLE IF NOT EXISTS `venda` (
  ...
  `dataHora` varchar(50) NOT NULL DEFAULT 'CURRENT_TIMESTAMP',
