...
-- Copiando estrutura para tabela lanchonete_2d_2024.entrega
...
-- Copiando dados para a tabela lanchonete_2d_2024.entrega: ~0 rows (aproximadamente)
DELETE FROM `entrega`;
...
CREATE TABLE `vi_notinhadetalhada` (
	...
	`precoUnitario` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
