...
CREATE TABLE IF NOT EXISTS `entregas` (
  ...
  PRIMARY KEY (`codEntrega`,`cliente_codCliente`) USING BTREE,
...
CREATE TABLE IF NOT EXISTS `fornecedor` (
  ...
  `itensvenda_codItemVenda` int NOT NULL,
  PRIMARY KEY (`codFornecedor`,`itensvenda_codItemVenda`) USING BTREE,
  KEY `itensvenda_codItemVenda` (`itensvenda_codItemVenda`),
