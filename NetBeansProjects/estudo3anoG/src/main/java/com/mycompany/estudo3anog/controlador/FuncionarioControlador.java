...
import com.mycompany.estudo3anog.modelo.dao.FuncionarioDAO;
...
public class FuncionarioControlador extends HttpServlet {
    ...
    String nomeFuncionario = "", codigoFuncionario = "",
            nascimentoFuncionario = "", cidadeFuncionario = "", salarioFuncionario = "",
            opcao;
    ...
    private void cadastrar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        objFuncionario.setNascimentoFuncionario(converte.converteCalendario(nascimentoFuncionario));
        objFuncionario.getObjCidade().setCodigoCidade(Integer.valueOf(cidadeFuncionario));
